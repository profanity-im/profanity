...
main(int argc, char* argv[])
{
    ...
    const struct CMUnitTest all_tests[] = {
        ...
        cmocka_unit_test(strip_arg_quotes__unescapes),
        ...
        cmocka_unit_test(jid_is_valid__is__false_for_empty_string),
        ...
        cmocka_unit_test(parse_args__returns__escaped_quotes),
        cmocka_unit_test(parse_args__returns__escaped_spaces),
        cmocka_unit_test(parse_args__returns__escaped_backslash),
