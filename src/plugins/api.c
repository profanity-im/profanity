...
api_chat_show(const char *const barejid, const char *message)
{
    ...
    char *parsed = str_replace(message, "\r\n", "\n");
    win_println((ProfWin*)chatwin, 0, parsed);
    free(parsed);
    ...
    const char *const ch, const char *const message)
{
    ...
    win_print((ProfWin*)chatwin, show_ch, 0, NULL, 0, themeitem, "", parsed);
    free(parsed);
...
api_room_show(const char *const roomjid, const char *message)
{
    ...
    char *parsed = str_replace(message, "\r\n", "\n");
    win_println((ProfWin*)mucwin, 0, parsed);
    free(parsed);
    ...
    const char *const ch, const char *const message)
{
    ...
    win_print((ProfWin*)mucwin, show_ch, 0, NULL, 0, themeitem, "", parsed);
    free(parsed);
